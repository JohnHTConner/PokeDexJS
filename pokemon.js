...
async function fetchPokemonDataBeforeRedirect(id){
    try {
        ...
        console.error("Failed to retrieve Pokémon data before redirect.")
    }
}

// emptying list wrapper, so reload doesn't scrap new ones
function displayPokemons(pokemon){
    listWrapper.innerHTML="";

    // using ID's to target each pokemon
    pokemon.forEach((pokemon) =>{
        ...
        // adds all list items to wrapper
